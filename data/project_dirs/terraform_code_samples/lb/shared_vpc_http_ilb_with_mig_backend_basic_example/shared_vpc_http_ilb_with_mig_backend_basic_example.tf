...
# [START cloudloadbalancing_shared_vpc_http_lb_backend_service]
# backend service
...
# [END cloudloadbalancing_shared_vpc_http_lb_backend_service]

# [START cloudloadbalancing_shared_vpc_http_url_map]
# URL map
...
# [END cloudloadbalancing_shared_vpc_http_url_map]
