...
from prompts.chat_prompts import build_architecture_prompt, build_revised_architecture_prompt, build_improvements_prompt, build_terraform_prompt, build_correct_terraform_prompt
